...
(function( root, factory ) {
	...
	function syncBackground( slide ) {
		...
		var data = {
            ...
            backgroundLogo: slide.getAttribute( 'data-background-logo' ),
        ...
        if (data.backgroundLogo || data.backgroundImage) {
	...
	function loadSlide( slide, options ) {
		...
		if( background ) {
			...
			if( background.hasAttribute( 'data-loaded' ) === false ) {
				...
				if( backgroundImage ) {
                    if (backgroundLogo) {
					    backgroundContent.style.backgroundImage = 'url(' + encodeURI( backgroundLogo ) +'), url('+ encodeURI( backgroundImage ) +')';
                    } else {
